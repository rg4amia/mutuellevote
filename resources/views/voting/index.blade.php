                ...
                <div>
                    ...
                    <div class="login-main">
                        <form  method="POST" class="theme-form" action="{{ route('session.generatecode') }}">
                            @csrf()
                            <h4>Obtenez un code ici.</h4>
                            <p>Entrez votre email et votre telephone pour obtenir</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input position-relative">
                                    <input class="form-control" type="text" name="telephone" required="" placeholder="0101010101">
                                    {{--<div class="show-hide">
                            ...
                            <div class="form-group mb-0">
                                <button class="btn btn-primary btn-block w-100" type="submit">Verifier & Obtenir un code ici</button>
                            </div>
                        </form>
                    </div>
                </div>
