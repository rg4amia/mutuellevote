    ...
    <div class="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
        <div class="flex-1 h-full max-w-1xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
                <h2 class="my-6 text-2xl text-center font-semibold text-green-700 dark:text-green-200 bg-green-100">
                    LES CANDIDATS À LA PRESIDENCE DE LA MUDTS
                </h2>
               ...
               <div class="flex flex-col md:px-40 overflow-y-auto md:flex-row">
                       ...
                       <div class="flex text-center justify-center sm:p-12">
                            <div class="rounded rounded-t-lg overflow-hidden shadow max-w-xs my-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="my-6 text-base overflow-x-auto font-semibold text-gray-700 dark:text-gray-200">Vote provisoire
                                    </h3>
                                    <h5 class="my-6 text-3xl overflow-x-auto font-semibold text-gray-700 dark:text-gray-200">{{ $candidat->vote
                                        }}</h5>
                                </div>
                            </div>
                        </div>
                ...
                <h2 class="my-6 text-2xl text-center font-semibold text-green-700 dark:text-green-200 bg-green-100">
                    LES CANDIDATS AU COMMISSARIAT-ADJOINT DE LA MUDTS
                </h2>
                <div class="flex flex-col md:px-40 overflow-y-auto md:flex-row">
                    <h3 class="my-6 text-2xl overflow-x-auto font-semibold text-gray-700 dark:text-gray-200">
                    ...
                    <div class="flex text-center justify-center sm:p-12">
                        <div class="rounded rounded-t-lg overflow-hidden shadow max-w-xs my-3">
                            ...
                            <div class="text-center">
                                ...
                                <h5 class="my-6 text-3xl overflow-x-auto font-semibold text-gray-700 dark:text-gray-200">{{
                                    $commissaire->vote }}</h5>
                            </div>
                        </div>
                    </div>
