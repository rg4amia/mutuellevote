...
class CreateDigitParamDistrictsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('digit_param_districts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('digit_param_districts');
    }
}
